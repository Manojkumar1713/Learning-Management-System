<?php
    ...
    $f = false;
	  if(isset($_POST['signupbtn'])){
		...
		$psw = $_POST['psw'];
    $course = $_POST['course'];
    $sql1 = "select * from facultylogin where register='$reg' and password='$psw';";
		$sql = "Insert into facultylogin(register,password,course) VALUES('$reg','$psw','$course')";
    $flag = false;
      ...
      if($flag){
        ...
        echo "<script>alert('you have already registerd');</script>";
      }
	}
?>
