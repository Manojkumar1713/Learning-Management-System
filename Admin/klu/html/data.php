             ...
             <div class="container-fluid">
                 <div class="row bg-title">
                     <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                         <h4 class="page-title">Add Subject Data For Respective Course</h4> </div>
                 ...
                 if($res)
                 {
                   ...
                   <div class="alert  alert-success">
                     <strong>Success</strong> Data Successfully Added to the <?php echo $table; ?> Table
                   </div>
                   <?php
                 }
                 ?>
                 ...
                 <div class="row">
                   <form method ="post" enctype="multipart/form-data">
                     <div calss = "form-group">
                       ...
                       <input type = "text" name="unit" id="name" class="form-control" required>
                     </div>
                     <div calss = "form-group">
