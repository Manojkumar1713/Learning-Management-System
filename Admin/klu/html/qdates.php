...
$unit = $_POST['unit'];
$date = $_POST['date'];
$query = "insert into dates(topic,unit,date) values('$table','$unit','$date')";
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Enter Last date for Submitting Quiz</h4> </div>
                ...
                <form method="post">
                      <div class="form-group">
                          <label class="unit">Enter unit number</label>
