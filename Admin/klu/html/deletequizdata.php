...
{
  $x=$_GET['del'];
  $sql = "delete from `$table` where Qid =$x";
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Deleting Assignment Questions</h4> </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <div class="white-box">
                          <h3 class="box-title">Delete Quiz Question</h3>
                              ...
                              <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    while($row =mysqli_fetch_array($res))
                                    {
                                      ...
                                      <td>
                                        <a class="btn btn-info" href="deletequizdata.php?del=<?php echo $row['Qid']; ?>">DELETE QUESTION </a>
                                      </td>
                                    </tr>
                                    <?php
                                    $count++;
